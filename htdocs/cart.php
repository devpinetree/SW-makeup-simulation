...
<tr align="center" >
 ...
 ?>
  ...
  <tr align="right">
   ...
   <td><button><a href="index.php" style="text-decoration:none;color:black">Continue Shopping</a></button>

   <td><button><a href="order.php" style="text-decoration:none;color:black">Order</a></button>
   </td>
