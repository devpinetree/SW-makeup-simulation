...
insert into `ad_log` (`id`,`aname`,`apwd`,`secques`) values (1,'ronica8558','1234','house');
...
insert into `brands` (`brand_id`,`brand_title`) values (1,'Nars'),(2,'Missha'),(3,'3CE'),(4,'UrbanDekay'),(5,'Mac'),(6,'Etude');
...
insert into `categories` (`cat_id`,`cat_title`) values (1,'lipstick'),(2,'eyeshadow'),(3,'blusher');
