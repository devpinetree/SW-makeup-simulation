...
function getcats(){
    ...
    echo "<li class=even><a href='logindex.php?cat=$cat_id'>$cat_title</a></li>";
	}
...
function getbrands(){
    ...
    echo "<li class=even><a href='logindex.php?brand=$brand_id'>$brand_title</a></li>"; 
...
function getpro(){
    ...
    while($row_pro = mysqli_fetch_array($run_pro)){
        ...
        <div class='center_prod_box'>
          ...
          <div class='prod_price'><span class='price'> $product_price Won</span></div>
        </div>
        <div class='bottom_prod_box'></div>
        <div class='prod_details_tab'> <a href='logindex.php?addcart=$product_id' title='header=[Add to cart] body=[&nbsp;] fade=[on]''><img src='images/cart.gif' alt='' border='0' class='left_bt' /></a>
    ...
    while($row_pro = mysqli_fetch_array($run_pro)){
        ...
        <div class='oferta_content'> <img src='admin_area/product_images/$product_image' width='94' height='92' alt='' border='0' class='oferta_img' />
          <div class='oferta_details'>
            ...
            <a href='logdetails.php?pro_id=$product_id' class='details'>details</a> </div>
    ...
    echo"
        ...
        <div class='center_prod_box_big'>
          ...
          <div class='details_big_box'>
            ...
            <div class='specifications'><font color=#000>
            $product_description</font>
            </div>
            <div class='prod_price_big'> <span class='price'>  $product_price Won</span></div>
            <a href='logdetails.php?addcart=$product_id' class='addtocart'>add to cart</a> <a href='logindex.php' class='compare'>Home</a> </div>
        </div>
...
function get_pro_cat(){
    ...
    $count_row = mysqli_num_rows($run_pro_cat);
     ...
     if($count_row==0){
    	...
    	echo "<script>window.open('logindex.php','_self')</script>";
    }
    ...
    while($row_pro_cat = mysqli_fetch_array($run_pro_cat)){
        ...
        <div class='bottom_prod_box'></div>
        <div class='prod_details_tab'> <a href='logindex.php?pro_id=$product_id' title='header=[Add to cart] body=[&nbsp;] fade=[on]''><img src='images/cart.gif' alt='' border='0' class='left_bt' /></a>
          <a href='logdetails.php?pro_id=$product_id' class='prod_details'>details</a> </div>
      </div>
